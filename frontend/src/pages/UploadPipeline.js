            ...
            <div className="max-w-3xl mx-auto">
                ...
                >
                    ...
                    <p className="text-gray-500 mb-8">
                        Upload your recruitment pipeline data with candidate statuses. Supported formats: CSV, XLSX
                    </p>
                    ...
                    <div className="card mb-8">
                        ...
                        <div className="flex flex-wrap gap-2 mt-2">
                            {['Name', 'Email', 'Phone Number', 'Job Role', 'Status'].map((col) => (
                                <span 
                                    key={col}
                        ...
                        <div className="mt-4">
                            <p className="label-small">Valid Status Values</p>
                            <div className="flex flex-wrap gap-2 mt-2">
                                {['Shortlisted', 'Rejected', 'Scheduled', 'Attended', 'Not Attended', 'Not Scheduled'].map((status) => (
                                    <span 
                                        key={status}
